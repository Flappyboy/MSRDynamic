 ...
 * @Version 1.0
 */
public class BaseStrategyWithCurrentCall implements Strategy {
    ...
    private class AddCallInfoFunction{
        ...
        void addCallInfoThroughStackTrace(List<StackTraceElement> stackTraceElements, Method method){
            ...
            if(callChain.currentCall==null) {
                ...
                int depth = callChain.getCurrentDepth();
                int index = stackTraceElements.size()-depth-1;
                callChain.currentCall.addChildCall(generateCallChainFromStackTrace(callChain.currentCall.getCallee(), stackTraceElements, index, method));
            }
        }
